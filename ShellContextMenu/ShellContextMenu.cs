...
namespace ShellContextMenu {
    ...
    public class ShellContextMenu : NativeWindow {
        ...
        private IntPtr[] GetPIDLs (DirectoryInfo[] arrFI) {
            ...
            var directoryInfo = arrFI[0].Parent;
            if (directoryInfo != null) {
                IShellFolder oParentFolder = GetParentFolder (directoryInfo.FullName);
                if (null == oParentFolder) {
                    return null;
                }
                ...
                throw new ShellContextMenuException ("Unable to retrieve Parent for DirectoryInfo");
            }
        }
        #endregion
